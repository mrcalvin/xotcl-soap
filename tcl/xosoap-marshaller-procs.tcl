...
namespace eval ::xosoap::marshaller {
  ...
  SoapElement ad_instproc parseAttributes {node} {
	...
	if {[string equal [lindex $attrib 0] [lindex $attrib 1]] && [string equal [lindex $attrib 2] ""]} {
	  my registerNS [list [lindex $attrib 0] [$node getAttribute "xmlns:[lindex $attrib 0]"]]
  ...
  ::xotcl::Class SoapEnvelope -superclass SoapElement -parameter {
    encodingStyle 
    nsEnvelopeVersion
  } -ad_doc {
  ...
  ::xotcl::Class SoapBodyEntry -superclass SoapElement \
      -parameter {targetMethod} -ad_doc {
  ...
  ::xotcl::Class SoapBodyResponse -parameter {
    {responseValue {}}
  ...
  ::xotcl::Class SoapBodyRequest -parameter {
    remoteMethod
    remoteArgs
  } -superclass SoapBodyEntry 
